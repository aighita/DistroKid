...
export class UserFileApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for apiUserFileAddPost without sending the request
     */
    ...
    /**
     * Creates request options for apiUserFileDownloadIdGet without sending the request
     */
    ...
    /**
     * Creates request options for apiUserFileGetPageGet without sending the request
     */
