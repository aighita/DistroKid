...
export class EventApi extends runtime.BaseAPI {
    ...
    /**
     * Creates request options for apiEventAddPost without sending the request
     */
    ...
    /**
     * Creates request options for apiEventDeleteIdDelete without sending the request
     */
    ...
    /**
     * Creates request options for apiEventGetByIdIdGet without sending the request
     */
    ...
    /**
     * Creates request options for apiEventGetPageGet without sending the request
     */
    ...
    /**
     * Creates request options for apiEventUpdateIdPut without sending the request
     */
