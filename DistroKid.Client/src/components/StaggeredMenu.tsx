...
export interface StaggeredMenuProps {
  ...
  contactInfo?: { type: string; value: string; link?: string }[];
  accentColor?: string;
  isFixed: boolean;
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            >
              ...
              {items && items.length ? (
                ...
                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                  <span className="sm-panel-item relative text-black font-semibold text-[4rem] cursor-pointer leading-none tracking-[-2px] transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]">
                    <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                      Fără elemente
                    </span>
                  </span>
            ...
            {workingHours && workingHours.length > 0 && (
              <div className="sm-hours mt-4 flex flex-col gap-2">
                <h3 className="sm-section-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">Quick Stats</h3>
                <ul className="sm-hours-list list-none m-0 p-0 flex flex-col gap-1 text-[1rem] text-[#444]">
                  {workingHours.map((h, i) => (
                    <li key={i} className="flex justify-between border-b border-black/5 pb-1">
                      ...
                      <span className="text-[#0088FF] font-semibold">{h.hours}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">Social Platforms</h3>
                <ul
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; background: transparent; pointer-events: none; z-index: 20; isolation: auto; }
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
...
.sm-scope .sm-panel-title { margin: 0; font-size: 1rem; font-weight: 600; color: #fff; text-transform:; }
.sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.5rem; }
.sm-scope .sm-panel-item { position: relative; color: #000; font-weight: 600; font-size: 4rem; cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform:; transition: background 0.25s, color 0.25s; display: inline-block; text-decoration: none; padding-right: 1.4em; }
