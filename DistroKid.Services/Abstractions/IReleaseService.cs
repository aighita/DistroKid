...
public interface IReleaseService
{
    ...
    public Task<ServiceResponse<PagedResponse<ReleaseRecord>>> GetReleases(PaginationSearchQueryParams pagination, CancellationToken cancellationToken = default);
