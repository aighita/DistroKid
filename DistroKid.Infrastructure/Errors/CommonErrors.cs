...
{
    public static ErrorMessage UserNotFound => new(HttpStatusCode.NotFound, "No account found with this email. Please check your email or register a new account.", ErrorCodes.EntityNotFound);
